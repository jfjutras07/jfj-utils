import pandas as pd
import numpy as np
from data_preprocessing.feature_engineering import mi_classification

#--- Function : test_mi_classification_basic ---
def test_mi_classification_basic():
    X = pd.DataFrame({
...
#--- Function : test_mi_classification_sorted_descending ---
def test_mi_classification_sorted_descending():
    X = pd.DataFrame({
...
#--- Function : test_mi_classification_categorical_handling ---
def test_mi_classification_categorical_handling():
    X = pd.DataFrame({
